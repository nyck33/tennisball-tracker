...
class BalloonDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        '''
        For Circle, does not give x, y of outline
        "frame11.jpg75980": {
        "fileref": "",
        "size": 75980,
        ...
        #for Colab:
        #annotation = json.load("drive/My Drive/matterport-balltracker/sample2/valid/via_region_data.json")
        ...
        for a in annotations:
            ...
            #Convert the circle into a skimage circle parameter before passing into self.add_image
            '''
            ...
            #rr, cc are ndarray of int, pixel coordinates of circle
            rr, cc = skimage.draw.circle_perimeter(p["cx"], p["cy"], p["r"])
            '''
            self.add_image(
                "tennisball",
                image_id=a['filename'],  # use file name as a unique image id
                path=image_path,
                width=width, height=height, #width and height of screen
                circles=circles) #shape attributes
            '''
            self.add_image(
                "tennisball",
                image_id=a['filename'],  # use file name as a unique image id
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        for i, p in enumerate(info["circles"]):
            ...
            ## Ref: https://stackoverflow.com/questions/19666626/
            #replace-all-elements-of-python-numpy-array-that-are-greater-than-some-value
            #replace all rr, cc > mask.shape[0]-1 with mask.shape[0]-1
